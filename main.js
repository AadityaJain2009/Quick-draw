...
sketch = quick_draw_data_set[randon_number];
...
function gotResults(error , results)  {
    ...
    console.log(results);
    document.getElementById('seem').innerHTML =  results[0].label;
    document.getElementById('acc').innerHTML =  Math.round(results[0].confidence * 100) + '%';
